...
function buildMessageEmail({ recipientName, senderName }) {
  ...
  const html = [
    ...
    '<p style="margin: 0 0 12px;"><img src="https://www.wimmel-welt.de/hero-family.svg" alt="Wimmel Welt" width="120" height="90" style="display: block; border: 0;" /></p>',
    `<p style="margin: 0 0 12px;">Hallo ${recipientName},</p>`,
    `<p style="margin: 0 0 16px;">${intro}</p>`,
    '<p style="margin: 0 0 24px;">Herzliche Grüße<br />Dein Wimmel Welt Team</p>',
    '<table role="presentation" cellpadding="0" cellspacing="0" border="0" style="border-collapse: separate; border-spacing: 0; width: 100%; max-width: 720px; background: #f8fafc; border-radius: 16px;">',
    '<tr>',
    '<td style="padding: 20px;">',
    '<div style="font-size: 30px; font-weight: 700; color: #111827;">Wimmel Welt - Kindertagespflegevermittlung</div>',
    '<div style="display: inline-block; margin-top: 10px; background: #c7d2fe; color: #111827; border-radius: 12px; padding: 10px 16px; font-size: 18px; font-weight: 600;">support</div>',
    '</td>',
    '</tr>',
    '<tr>',
    '<td style="padding: 0 20px 20px;">',
    '<table role="presentation" cellpadding="0" cellspacing="0" border="0" style="border-collapse: separate; border-spacing: 0; width: 100%; background: #ffffff; border-radius: 14px;">',
    '<tr>',
    '<td style="padding: 14px 16px;">',
    '<a href="mailto:info@wimmel-welt.de" style="text-decoration: none; color: #111827; font-size: 18px;">info@wimmel-welt.de</a>',
    '</td>',
    '<td style="padding: 14px 16px;">',
