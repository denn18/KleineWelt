  ...
  return (
    <section className="mx-auto flex w-full max-w-4xl flex-col gap-8 rounded-3xl bg-white/85 p-10 shadow-lg">
      <header className="flex flex-col gap-2">
        <p className="text-sm font-semibold uppercase tracking-wide text-brand-500">Kontakt</p>
        <h1 className="text-3xl font-semibold text-brand-700">Wir freuen uns auf deine Nachricht</h1>
      ...
      <div className="rounded-2xl border border-brand-100 bg-brand-50/60 p-6">
        <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
          <div>
            ...
            <p className="text-xs text-slate-500">Klicke auf den Button, um die Adresse in die Zwischenablage zu kopieren.</p>
          </div>
          <button
            type="button"
      ...
      <form onSubmit={handleSubmit} className="grid gap-4 rounded-3xl border border-brand-100 bg-white/80 p-6">
