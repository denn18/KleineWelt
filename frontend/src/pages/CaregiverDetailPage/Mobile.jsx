...
export default function Mobile() {
  ...
  function handleLoginClick() {
    trackEvent('engagement_login_page', { page: 'caregiver_detail', platform: 'mobile', location: 'contact' });
    navigate('/login', { state: { from: location.pathname } });
  }
        ...
        {user ? (
          ...
          <div className="flex flex-col items-start gap-3">
            ...
            <button
              ...
              className="rounded-full bg-brand-600 px-6 py-3 text-center text-sm font-semibold text-white shadow-sm transition duration-200 hover:bg-brand-700 hover:shadow-md"
            >
              Anmelden
            </button>
          </div>
